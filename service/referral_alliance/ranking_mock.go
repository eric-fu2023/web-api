...
func generateMockRankings() []cache.ReferralAllianceRanking {
	...
	for _, mockRanking := range mockRewardRankings {
		...
		defaultRewardAmount := mockRanking.DefaultRewardAmountUSD
		if os.Getenv("DEFAULT_CURRENCY") == "INR" {
			defaultRewardAmount = mockRanking.DefaultRewardAmountINR
		}
		rewardMaxValue := int64(float64(defaultRewardAmount) * mockRankingRangeRatePos)
		rewardMinValue := int64(float64(defaultRewardAmount) * mockRankingRangeRateNeg)
...
// TODO can consider moving to DB or config
const (
...
type MockRanking struct {
	...
	DefaultRewardAmountUSD int64
	DefaultRewardAmountINR int64
}
	...
	mockRewardRankings = []MockRanking{
		{
			...
			DefaultRewardAmountUSD: 1309509,
			DefaultRewardAmountINR: 13095090,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 986578,
			DefaultRewardAmountINR: 9865780,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 503489,
			DefaultRewardAmountINR: 5034890,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 400380,
			DefaultRewardAmountINR: 4003800,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 98823,
			DefaultRewardAmountINR: 988230,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 45609,
			DefaultRewardAmountINR: 456090,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 35515,
			DefaultRewardAmountINR: 355150,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 15023,
			DefaultRewardAmountINR: 150230,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 6323,
			DefaultRewardAmountINR: 63230,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 25030,
			DefaultRewardAmountINR: 250300,
		...
		},
		{
			...
			DefaultRewardAmountUSD: 0,
			DefaultRewardAmountINR: 0,
