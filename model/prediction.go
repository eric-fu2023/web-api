...
func preloadPredictions() *gorm.DB {
	return DB.
		...
		Preload("PredictionSelections.FbOdds.RelatedOdds.FbOddsOrderRequestList").
		Preload("PredictionSelections.FbOdds.RelatedOdds.FbOddsOrderRequestList.TayaBetReport").
